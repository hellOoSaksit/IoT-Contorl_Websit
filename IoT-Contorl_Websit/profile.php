    ...
    if ($getUinfo) {
     ...
     ?>
          ...
          <form class="" action="" method="POST">
              ...
              ">
                ...
                <?php }elseif($getUinfo->roleid == '2'){?>
                  ...
                  <option value="2" selected='selected'>ผู้แก้ไขระบบ</option>
                  <option value="3">ผู้ใช้งาน</option>
          ...
          <?php } ?>
              ...
              <div class="form-group">
                <button type="submit" name="update" class="btn btn-success">อัพเดตการแก้ไข</button>
                <a class="btn btn-primary" href="changepass.php?id=<?php echo $getUinfo->id;?>">แก้ไขรหัสผ่าน</a>
              </div>
